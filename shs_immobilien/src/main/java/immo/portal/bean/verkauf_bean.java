...
public class verkauf_bean implements Serializable{
	...
	public verkauf_bean(Long id, String haustyp, String bautyp, String titel, Integer baujahr,
			Integer wohnflaeche, Integer grundstuecksflaeche, String standort, Integer startgebot, String beschreibung,
			String dateiname, byte[] bilder) {
		super();
		this.id = id;
