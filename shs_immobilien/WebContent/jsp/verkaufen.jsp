			...
			<div class="textfeld">
				<form id="verkaufForm" class="ansicht" action="../VerkaufServlet" method=post
					...
					<table>
						...
						<tr>
							<td>
									<button class="abschicken" type="submit"
										name="vformular_absenden" value="${benutzer.id}">Absenden</button>
								</td>
							<td>
								<button class="abbrechen" type="submit" value="Abbrechen"
									onclick="location.href = '../html/hauptseite.html'">Abbrechen</button>
							</td>
						</tr>
